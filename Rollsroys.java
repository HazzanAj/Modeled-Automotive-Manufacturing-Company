public class Rollsroys extends VehicleProductionCompany {
    public Rollsroys() {
    ...
    public void produceBranchInformation() {
        System.out.println("Company's Name : ROLLSROYS GERMANY");
        System.out.println("Location : 1A XYZ Street DRESDEN");
